...
import { setModalWaiting } from 'redux/reducers/ModalReducer';
//-------------------------------------------------------

export default function ModalAllowance() { // receive props from parent

  // redux store
  const dispatch = useDispatch();
  const { modalWaiting } = useSelector((state) => state.ModalReducer)
    ...
    <>
      ...
      <div className="_modal" style={{ zIndex: 100 }}>
        <div className="border-white border-2 shadow-2xl bg-white  mx-auto rounded-3xl z-50 overflow-y-auto w-96 animated zoomIn">
          ...
          {/* <div className="flex justify-center bg-gray-200" style={{ minHeight: 100 }}>
            <img src="/assets/img/allowance1.gif" alt="loader" />
          </div> */}

          <div className="modal-content py-4 px-6  text-center bg-gray-200">
            <p className="text-gray-700  mb-2 font-bold"> PREPARING YOUR WALLET ALLOWANCE</p>
