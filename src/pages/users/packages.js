 ...
 <section className="bg-white dark:bg-gray-900 mt-10 lg:mt-0">
  <div className="py-8 px-4 mx-auto  lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-lg text-center mb-8 lg:mb-12">
          ...
          <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at Fivefortune we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
