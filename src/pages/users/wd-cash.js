...
export default function Summary() {
    ...
    const { isLogin, username, Ewallet } = useSelector((state) => state.AuthReducer)
    ...
    return (
        <>
            ...
            <div className="min-h-screen pb-40 px-2 animated fadeIn">
                ...
                <div className="flex border mt-2 py-5 border-gray-700 bg-gray-900 rounded-xl justify-center">

                <p>EWallet Balance : {Ewallet} USDT</p>

                </div>

                <div className="border mt-10 py-5 border-gray-700 bg-gray-900 rounded-xl">
